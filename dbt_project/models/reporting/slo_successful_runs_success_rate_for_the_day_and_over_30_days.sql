...
SELECT pipeline_name,
       ...
       COALESCE(success_rate_for_the_day < 95.00, TRUE) is_slo_threshold_for_the_day_breached,
       success_rate_over_30_days,
       COALESCE(success_rate_over_30_days < 99.00, TRUE) is_slo_threshold_over_30_days_breached
