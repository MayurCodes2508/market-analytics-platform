from psycopg2.errors import IntegrityError, InterfaceError, DatabaseError, ProgrammingError, OperationalError, NotSupportedError, DataError, InternalError
...
class DBExceptions:
    ...
    exceptions = {
        ...
        InterfaceError: ("Driver Interface Error: Connection Layer Failed On Python Side"),

        ProgrammingError: ("SQL Syntax Error: Incorrect SQL Syntax"),

        OperationalError: ("Operational Disruption: Network/Connection Gave Out Mid-Way"),
